...
function Edit({
  ...
  useEffect(() => {
    if (!uniqueId) {
      setAttributes({
        uniqueId: 'general-blocks-' + clientId.slice(0, 8)
      });
    }
  }, []);
...
const Inspector = ({
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(InspectorControls, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(PanelBody, {
    title: __('Test Block Settings', 'general-blocks')
...
module.exports = JSON.parse('{"apiVersion":2,"name":"general-blocks/test","version":"0.1.0","title":"Test Block","category":"general-blocks","icon":"smiley","description":"Example block written with ESNext standard and JSX support build step required.","supports":{"html":false,"anchor":true},"textdomain":"general-blocks","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css"}');
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkgeneral_blocks"] = self["webpackChunkgeneral_blocks"] || [];
